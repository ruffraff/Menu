 ...
 */
class getCookingTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\CookingTypeRepository' shared autowired service.
     *
     * @return \App\Repository\CookingTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'CookingTypeRepository.php';

        return $container->privates['App\\Repository\\CookingTypeRepository'] = new \App\Repository\CookingTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
