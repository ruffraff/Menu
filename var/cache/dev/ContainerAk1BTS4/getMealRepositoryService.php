 ...
 */
class getMealRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MealRepository' shared autowired service.
     *
     * @return \App\Repository\MealRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MealRepository.php';

        return $container->privates['App\\Repository\\MealRepository'] = new \App\Repository\MealRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
