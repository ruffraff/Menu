 ...
 */
class getMacroElementTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MacroElementTypeRepository' shared autowired service.
     *
     * @return \App\Repository\MacroElementTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MacroElementTypeRepository.php';

        return $container->privates['App\\Repository\\MacroElementTypeRepository'] = new \App\Repository\MacroElementTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
