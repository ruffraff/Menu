 ...
 */
class getMacroElementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MacroElementRepository' shared autowired service.
     *
     * @return \App\Repository\MacroElementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MacroElementRepository.php';

        return $container->privates['App\\Repository\\MacroElementRepository'] = new \App\Repository\MacroElementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
