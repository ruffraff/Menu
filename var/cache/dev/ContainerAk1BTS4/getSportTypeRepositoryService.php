 ...
 */
class getSportTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SportTypeRepository' shared autowired service.
     *
     * @return \App\Repository\SportTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SportTypeRepository.php';

        return $container->privates['App\\Repository\\SportTypeRepository'] = new \App\Repository\SportTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
