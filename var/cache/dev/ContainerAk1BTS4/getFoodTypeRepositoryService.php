 ...
 */
class getFoodTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FoodTypeRepository' shared autowired service.
     *
     * @return \App\Repository\FoodTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FoodTypeRepository.php';

        return $container->privates['App\\Repository\\FoodTypeRepository'] = new \App\Repository\FoodTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
