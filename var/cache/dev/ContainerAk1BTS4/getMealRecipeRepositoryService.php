 ...
 */
class getMealRecipeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MealRecipeRepository' shared autowired service.
     *
     * @return \App\Repository\MealRecipeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MealRecipeRepository.php';

        return $container->privates['App\\Repository\\MealRecipeRepository'] = new \App\Repository\MealRecipeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
