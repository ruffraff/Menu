 ...
 */
class getBodyTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\BodyTypeRepository' shared autowired service.
     *
     * @return \App\Repository\BodyTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'BodyTypeRepository.php';

        return $container->privates['App\\Repository\\BodyTypeRepository'] = new \App\Repository\BodyTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
