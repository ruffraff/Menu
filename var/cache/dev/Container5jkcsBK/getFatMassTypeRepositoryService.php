 ...
 */
class getFatMassTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FatMassTypeRepository' shared autowired service.
     *
     * @return \App\Repository\FatMassTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FatMassTypeRepository.php';

        return $container->privates['App\\Repository\\FatMassTypeRepository'] = new \App\Repository\FatMassTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
