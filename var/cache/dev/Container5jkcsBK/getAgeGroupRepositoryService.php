 ...
 */
class getAgeGroupRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\AgeGroupRepository' shared autowired service.
     *
     * @return \App\Repository\AgeGroupRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'AgeGroupRepository.php';

        return $container->privates['App\\Repository\\AgeGroupRepository'] = new \App\Repository\AgeGroupRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
