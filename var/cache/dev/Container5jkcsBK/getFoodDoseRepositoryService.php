 ...
 */
class getFoodDoseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FoodDoseRepository' shared autowired service.
     *
     * @return \App\Repository\FoodDoseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FoodDoseRepository.php';

        return $container->privates['App\\Repository\\FoodDoseRepository'] = new \App\Repository\FoodDoseRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
