 ...
 */
class getFoodEnergyRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\FoodEnergyRepository' shared autowired service.
     *
     * @return \App\Repository\FoodEnergyRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'FoodEnergyRepository.php';

        return $container->privates['App\\Repository\\FoodEnergyRepository'] = new \App\Repository\FoodEnergyRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
