 ...
 */
class getZoneGroupRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\ZoneGroupRepository' shared autowired service.
     *
     * @return \App\Repository\ZoneGroupRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'ZoneGroupRepository.php';

        return $container->privates['App\\Repository\\ZoneGroupRepository'] = new \App\Repository\ZoneGroupRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
