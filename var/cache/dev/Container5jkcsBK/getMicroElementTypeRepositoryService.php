 ...
 */
class getMicroElementTypeRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MicroElementTypeRepository' shared autowired service.
     *
     * @return \App\Repository\MicroElementTypeRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MicroElementTypeRepository.php';

        return $container->privates['App\\Repository\\MicroElementTypeRepository'] = new \App\Repository\MicroElementTypeRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
