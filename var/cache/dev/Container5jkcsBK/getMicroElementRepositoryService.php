 ...
 */
class getMicroElementRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\MicroElementRepository' shared autowired service.
     *
     * @return \App\Repository\MicroElementRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'MicroElementRepository.php';

        return $container->privates['App\\Repository\\MicroElementRepository'] = new \App\Repository\MicroElementRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
